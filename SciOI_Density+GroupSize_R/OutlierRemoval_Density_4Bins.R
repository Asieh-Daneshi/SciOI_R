...
data <- read_excel("C:\\Users\\Asieh\\Downloads\\SciOI_R-master\\SciOI_R-master\\SciOI_Density+GroupSize_R\\Responses_Main1_150Participants_2024-02-23.xlsx")
...
responseTimeTest_Bin1=matrix(, nrow = NP, ncol = NTest)   
responseTimeTest_Bin2=matrix(, nrow = NP, ncol = NTest)
responseTimeTest_Bin3=matrix(, nrow = NP, ncol = NTest)
responseTimeTest_Bin4=matrix(, nrow = NP, ncol = NTest)
for (a1 in 1:NP){
  responseTimeTestP1=as.numeric(responseTimeTest[a1,]<=(max(responseTimeTest)/4))
  responseTimeTest_Bin1[a1,0:length(responseTimeTestP1)] <- responseTimeTestP1
  responseTimeTestP2=as.numeric(responseTimeTest[a1,]>=(max(responseTimeTest)/4) & responseTimeTest[a1,]<=(max(responseTimeTest)/2))
  responseTimeTest_Bin2[a1,0:length(responseTimeTestP2)] <- responseTimeTestP2
  responseTimeTestP3=as.numeric(responseTimeTest[a1,]>=(max(responseTimeTest)/2) & responseTimeTest[a1,]<=(max(responseTimeTest)*3/4))
  responseTimeTest_Bin3[a1,0:length(responseTimeTestP3)] <- responseTimeTestP3
  responseTimeTestP4=as.numeric(responseTimeTest[a1,]>=(max(responseTimeTest)*3/4))
  responseTimeTest_Bin4[a1,0:length(responseTimeTestP4)] <- responseTimeTestP4
}
RadiusTestBin1 = RadiusTest*responseTimeTest_Bin1
NumberOfAgentsTestBin1 = NumberOfAgentsTest*responseTimeTest_Bin1                                                                                # participant's raised hand (right=1; left=0)
AgentHandTestBin1 = AgentHandTest*responseTimeTest_Bin1                                                                                                           # left hand:1; right hand:2
ParticipantHandTestBin1 = ParticipantHandTest*responseTimeTest_Bin1                                                                                               # left hand:2; right hand:1
responseTimeTestBin1 = responseTimeTest*responseTimeTest_Bin1                                                                                 # this is the RT+fixation duration which was 1s
DominantColorTestBin1 = DominantColorTest*responseTimeTest_Bin1

RadiusTestBin2 = RadiusTest*responseTimeTest_Bin2
NumberOfAgentsTestBin2 = NumberOfAgentsTest*responseTimeTest_Bin2                                                                                # participant's raised hand (right=1; left=0)
AgentHandTestBin2 = AgentHandTest*responseTimeTest_Bin2                                                                                                           # left hand:1; right hand:2
ParticipantHandTestBin2 = ParticipantHandTest*responseTimeTest_Bin2                                                                                               # left hand:2; right hand:1
responseTimeTestBin2 = responseTimeTest*responseTimeTest_Bin2                                                                                 # this is the RT+fixation duration which was 1s
DominantColorTestBin2 = DominantColorTest*responseTimeTest_Bin2

RadiusTestBin3 = RadiusTest*responseTimeTest_Bin3
NumberOfAgentsTestBin3 = NumberOfAgentsTest*responseTimeTest_Bin3                                                                                # participant's raised hand (right=1; left=0)
AgentHandTestBin3 = AgentHandTest*responseTimeTest_Bin3                                                                                                           # left hand:1; right hand:2
ParticipantHandTestBin3 = ParticipantHandTest*responseTimeTest_Bin3                                                                                               # left hand:2; right hand:1
responseTimeTestBin3 = responseTimeTest*responseTimeTest_Bin3                                                                                 # this is the RT+fixation duration which was 1s
DominantColorTestBin3 = DominantColorTest*responseTimeTest_Bin3

RadiusTestBin4 = RadiusTest*responseTimeTest_Bin4
NumberOfAgentsTestBin4 = NumberOfAgentsTest*responseTimeTest_Bin4                                                                                # participant's raised hand (right=1; left=0)
AgentHandTestBin4 = AgentHandTest*responseTimeTest_Bin4                                                                                                           # left hand:1; right hand:2
ParticipantHandTestBin4 = ParticipantHandTest*responseTimeTest_Bin4                                                                                               # left hand:2; right hand:1
responseTimeTestBin4 = responseTimeTest*responseTimeTest_Bin4                                                                                 # this is the RT+fixation duration which was 1s
DominantColorTestBin4 = DominantColorTest*responseTimeTest_Bin4
# =======================================================================================================================================================================================
...
# ***************************************************************************************************************************************************************************************
Follow_lowDensityBin1=(((ParticipantHandTestBin1==1 & AgentHandTestBin1==2)|(ParticipantHandTestBin1==2 & AgentHandTestBin1==1)) & RadiusTestBin1==6 & catchTrialTestBin1==0 & NumberOfAgentsTestBin1==1)
Follow_highDensityBin1=(((ParticipantHandTestBin1==1 & AgentHandTestBin1==2)|(ParticipantHandTestBin1==2 & AgentHandTestBin1==1)) & RadiusTestBin1==3.3 & catchTrialTestBin1==0 & NumberOfAgentsTestBin1==1)
Total_lowDensityBin1=(RadiusTestBin1==6 & catchTrialTestBin1==0 & NumberOfAgentsTestBin1==1)
Total_highDensityBin1=(RadiusTestBin1==3.3 & catchTrialTestBin1==0 & NumberOfAgentsTestBin1==1)

Follow_lowDensityBin2=(((ParticipantHandTestBin2==1 & AgentHandTestBin2==2)|(ParticipantHandTestBin2==2 & AgentHandTestBin2==1)) & RadiusTestBin2==6 & catchTrialTestBin2==0 & NumberOfAgentsTestBin2==1)
Follow_highDensityBin2=(((ParticipantHandTestBin2==1 & AgentHandTestBin2==2)|(ParticipantHandTestBin2==2 & AgentHandTestBin2==1)) & RadiusTestBin2==3.3 & catchTrialTestBin2==0 & NumberOfAgentsTestBin2==1)
Total_lowDensityBin2=(RadiusTestBin2==6 & catchTrialTestBin2==0 & NumberOfAgentsTestBin2==1)
Total_highDensityBin2=(RadiusTestBin2==3.3 & catchTrialTestBin2==0 & NumberOfAgentsTestBin2==1)

Follow_lowDensityBin3=(((ParticipantHandTestBin3==1 & AgentHandTestBin3==2)|(ParticipantHandTestBin3==2 & AgentHandTestBin3==1)) & RadiusTestBin3==6 & catchTrialTestBin3==0 & NumberOfAgentsTestBin3==1)
Follow_highDensityBin3=(((ParticipantHandTestBin3==1 & AgentHandTestBin3==2)|(ParticipantHandTestBin3==2 & AgentHandTestBin3==1)) & RadiusTestBin3==3.3 & catchTrialTestBin3==0 & NumberOfAgentsTestBin3==1)
Total_lowDensityBin3=(RadiusTestBin3==6 & catchTrialTestBin3==0 & NumberOfAgentsTestBin3==1)
Total_highDensityBin3=(RadiusTestBin3==3.3 & catchTrialTestBin3==0 & NumberOfAgentsTestBin3==1)

Follow_lowDensityBin4=(((ParticipantHandTestBin4==1 & AgentHandTestBin4==2)|(ParticipantHandTestBin4==2 & AgentHandTestBin4==1)) & RadiusTestBin4==6 & catchTrialTestBin4==0 & NumberOfAgentsTestBin4==1)
Follow_highDensityBin4=(((ParticipantHandTestBin4==1 & AgentHandTestBin4==2)|(ParticipantHandTestBin4==2 & AgentHandTestBin4==1)) & RadiusTestBin4==3.3 & catchTrialTestBin4==0 & NumberOfAgentsTestBin4==1)
Total_lowDensityBin4=(RadiusTestBin4==6 & catchTrialTestBin4==0 & NumberOfAgentsTestBin4==1)
Total_highDensityBin4=(RadiusTestBin4==3.3 & catchTrialTestBin4==0 & NumberOfAgentsTestBin4==1)

PercentageFollow_lowDensityBin1 <- matrix(, nrow = NP, ncol = 1)     
PercentageFollow_highDensityBin1 <- matrix(, nrow = NP, ncol = 1)     
PercentageFollow_lowDensityBin2 <- matrix(, nrow = NP, ncol = 1)     
PercentageFollow_highDensityBin2 <- matrix(, nrow = NP, ncol = 1)     
PercentageFollow_lowDensityBin3 <- matrix(, nrow = NP, ncol = 1)     
PercentageFollow_highDensityBin4 <- matrix(, nrow = NP, ncol = 1)     
PercentageFollow_lowDensityBin4 <- matrix(, nrow = NP, ncol = 1)     
PercentageFollow_highDensityBin4 <- matrix(, nrow = NP, ncol = 1)      
for (a1 in 1:NP){
