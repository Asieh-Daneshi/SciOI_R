...
data <- read_excel("E:\\OngoingAnalysis\\SciOI_R\\SciOI_Density+GroupSize_R\\Responses_Pilot1_OverallDensity_10Participants_2024-04_19.xlsx")
DensityData <- data[data[,3]=="DensityOverall",]
# Group Density ========================================================================================================================================================================
...
png(file="E:\\OngoingAnalysis\\SciOI_R\\SciOI_Density+GroupSize_R\\CatchCorrectnessHistDensity.png", width=1200, height=700)
...
png(file="E:\\OngoingAnalysis\\SciOI_R\\SciOI_Density+GroupSize_R\\CatchCorrectnessHistOutlierRemovedDensityOnlyAfterP.png", width=1200, height=700)
ggplot(data = framedData, aes(x = PercentageCorrectTest)) + geom_histogram(color="black", fill="aquamarine4") + theme_bw(base_size = 14) + theme(panel.border = element_blank(), panel.grid.major = element_blank(), panel.grid.minor = element_blank() , axis.line = element_line(size = .5, linetype = "solid", colour = "black")) + ggtitle("Performance on practice trials") + xlab("correct Percentage") + ylab("number of participants")
dev.off()
...
# ***************************************************************************************************************************************************************************************
# Follow_lowDensity1=(((ParticipantHandTest==1 & AgentHandTest==2)|(ParticipantHandTest==2 & AgentHandTest==1)) & RadiusTest==9 & catchTrialTest==0 & NumberOfAgentsTest==1)
...
# Total_lowDensity1=(RadiusTest==9 & catchTrialTest==0 & NumberOfAgentsTest==1)
# Total_highDensity1=(RadiusTest==3.3 & catchTrialTest==0 & NumberOfAgentsTest==1)

Follow_lowDensity3=(((ParticipantHandTest==1 & AgentHandTest==2)|(ParticipantHandTest==2 & AgentHandTest==1)) & RadiusTest==9 & catchTrialTest==0 & NumberOfAgentsTest==4)
Follow_highDensity3=(((ParticipantHandTest==1 & AgentHandTest==2)|(ParticipantHandTest==2 & AgentHandTest==1)) & RadiusTest==3.3 & catchTrialTest==0 & NumberOfAgentsTest==4)
Total_lowDensity3=(RadiusTest==9 & catchTrialTest==0 & NumberOfAgentsTest==4)
Total_highDensity3=(RadiusTest==3.3 & catchTrialTest==0 & NumberOfAgentsTest==4)

Follow_lowDensity5=(((ParticipantHandTest==1 & AgentHandTest==2)|(ParticipantHandTest==2 & AgentHandTest==1)) & RadiusTest==9 & catchTrialTest==0 & NumberOfAgentsTest==7)
Follow_highDensity5=(((ParticipantHandTest==1 & AgentHandTest==2)|(ParticipantHandTest==2 & AgentHandTest==1)) & RadiusTest==3.3 & catchTrialTest==0 & NumberOfAgentsTest==7)
Total_lowDensity5=(RadiusTest==9 & catchTrialTest==0 & NumberOfAgentsTest==7)
Total_highDensity5=(RadiusTest==3.3 & catchTrialTest==0 & NumberOfAgentsTest==7)
...
meanFollow_lowDensity <- c(mean(PercentageFollow_lowDensity3, na.rm=TRUE),mean(PercentageFollow_lowDensity5, na.rm=TRUE))
meanFollow_highDensity <- c(mean(PercentageFollow_highDensity3, na.rm=TRUE),mean(PercentageFollow_highDensity5, na.rm=TRUE))

stdFollow_lowDensity <- c(sd(PercentageFollow_lowDensity3, na.rm=TRUE),sd(PercentageFollow_lowDensity5, na.rm=TRUE))
stdFollow_highDensity <- c(sd(PercentageFollow_highDensity3, na.rm=TRUE),sd(PercentageFollow_highDensity5, na.rm=TRUE))
...
png(file="E:\\OngoingAnalysis\\SciOI_R\\SciOI_Density+GroupSize_R\\FollowDensityOnlyAfterP.png", width=1200, height=700)
...
DensityFactor <- c(rep("LowDensity",2),rep("HighDensity",2))
...
png(file="E:\\OngoingAnalysis\\SciOI_R\\SciOI_Density+GroupSize_R\\FollowRegressDensityOnlyAfterP.png", width=1200, height=700)
...
density <- c(rep("LowDensity",NP*2),rep("HighDensity",NP*2))
NumAgents <- c(rep(c(rep(1,NP),rep(2,NP)),2))
FollowPercentage <- c(PercentageFollow_lowDensity3,PercentageFollow_lowDensity5,PercentageFollow_highDensity3,PercentageFollow_highDensity5)
...
summary(mixed_model)
write.csv(df3GMM, "E:\\OngoingAnalysis\\SciOI_R\\SciOI_Density+GroupSize_R\\FollowDensityAfterAgnets.csv", row.names = FALSE)
# ***************************************************************************************************************************************************************************************
# Response time (follow) =========================================================================================================================================================================
# ***************************************************************************************************************************************************************************************
# RT_lowDensityF1 <- matrix(, nrow = NP, ncol = NTest)  
# length_lowDensityF1=rowSums(RadiusTest==9 & catchTrialTest==0 & NumberOfAgentsTest==1 & ((ParticipantHandTest==1 & AgentHandTest==2)|(ParticipantHandTest==2 & AgentHandTest==1)))

RT_lowDensityF3 <- matrix(, nrow = NP, ncol = NTest)  
length_lowDensityF3=rowSums(RadiusTest==9 & catchTrialTest==0 & NumberOfAgentsTest==4 & ((ParticipantHandTest==1 & AgentHandTest==2)|(ParticipantHandTest==2 & AgentHandTest==1)))

RT_lowDensityF5 <- matrix(, nrow = NP, ncol = NTest)  
length_lowDensityF5=rowSums(RadiusTest==9 & catchTrialTest==0 & NumberOfAgentsTest==7 & ((ParticipantHandTest==1 & AgentHandTest==2)|(ParticipantHandTest==2 & AgentHandTest==1)))
# ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
length_highDensityF3=rowSums(RadiusTest==3.3 & catchTrialTest==0 & NumberOfAgentsTest==4 & ((ParticipantHandTest==1 & AgentHandTest==2)|(ParticipantHandTest==2 & AgentHandTest==1)))

RT_highDensityF5 <- matrix(, nrow = NP, ncol = NTest)  
length_highDensityF5=rowSums(RadiusTest==3.3 & catchTrialTest==0 & NumberOfAgentsTest==7 & ((ParticipantHandTest==1 & AgentHandTest==2)|(ParticipantHandTest==2 & AgentHandTest==1)))
# ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
# for (a in 1:NP){
...
# }
for (a1 in 1:NP){
  # RT_lowDensityF1[a1,1:length_lowDensityF1[a1]]=responseTimeTest[a1,(RadiusTest[a1,]==9 & catchTrialTest[a1,]==0 & NumberOfAgentsTest[a1,]==1 & ((ParticipantHandTest[a1,]==1 & AgentHandTest[a1,]==2)|(ParticipantHandTest[a1,]==2 & AgentHandTest[a1,]==1)))]
  RT_lowDensityF3[a1,1:length_lowDensityF3[a1]]=responseTimeTest[a1,(RadiusTest[a1,]==9 & catchTrialTest[a1,]==0 & NumberOfAgentsTest[a1,]==4 & ((ParticipantHandTest[a1,]==1 & AgentHandTest[a1,]==2)|(ParticipantHandTest[a1,]==2 & AgentHandTest[a1,]==1)))]
  RT_lowDensityF5[a1,1:length_lowDensityF5[a1]]=responseTimeTest[a1,(RadiusTest[a1,]==9 & catchTrialTest[a1,]==0 & NumberOfAgentsTest[a1,]==7 & ((ParticipantHandTest[a1,]==1 & AgentHandTest[a1,]==2)|(ParticipantHandTest[a1,]==2 & AgentHandTest[a1,]==1)))]
  ...
  RT_highDensityF3[a1,1:length_highDensityF3[a1]]=responseTimeTest[a1,(RadiusTest[a1,]==3.3 & catchTrialTest[a1,]==0 & NumberOfAgentsTest[a1,]==4 & ((ParticipantHandTest[a1,]==1 & AgentHandTest[a1,]==2)|(ParticipantHandTest[a1,]==2 & AgentHandTest[a1,]==1)))]
  RT_highDensityF5[a1,1:length_highDensityF5[a1]]=responseTimeTest[a1,(RadiusTest[a1,]==3.3 & catchTrialTest[a1,]==0 & NumberOfAgentsTest[a1,]==7 & ((ParticipantHandTest[a1,]==1 & AgentHandTest[a1,]==2)|(ParticipantHandTest[a1,]==2 & AgentHandTest[a1,]==1)))]
}
# Barplot for response time (low density or high density) ===============================================================================================================================
meanRTF_lowDensity <- c(mean(RT_lowDensityF3, na.rm=TRUE),mean(RT_lowDensityF5, na.rm=TRUE))
meanRTF_highDensity <- c(mean(RT_highDensityF3, na.rm=TRUE),mean(RT_highDensityF5, na.rm=TRUE))

stdRTF_lowDensity <- c(sd(RT_lowDensityF3, na.rm=TRUE),sd(RT_lowDensityF5, na.rm=TRUE))
stdRTF_highDensity <- c(sd(RT_highDensityF3, na.rm=TRUE),sd(RT_highDensityF5, na.rm=TRUE))
...
AsiColors<- c("darkseagreen3", "darkolivegreen4")
png(file="E:\\OngoingAnalysis\\SciOI_R\\SciOI_Density+GroupSize_R\\RTFDensityOnlyAfterP.png", width=1200, height=700)
...
summary(fit1)
AsiColorsRegress<- c("darkolivegreen4","darkseagreen3")
png(file="E:\\OngoingAnalysis\\SciOI_R\\SciOI_Density+GroupSize_R\\RTFRegressDensityOnlyAfterP.png", width=1200, height=700)
...
density <- c(rep("LowDensity",NP*2),rep("HighDensity",NP*2))
NumAgents <- c(rep(c(rep(1,NP),rep(2,NP)),2))
RT <- c(rowMeans(RT_lowDensityF3,na=TRUE),rowMeans(RT_lowDensityF5,na=TRUE),rowMeans(RT_highDensityF3,na=TRUE),rowMeans(RT_highDensityF5,na=TRUE))
...
# length_lowDensityUF1=rowSums(RadiusTest==9 & catchTrialTest==0 & NumberOfAgentsTest==1 & ((ParticipantHandTest==1 & AgentHandTest==1)|(ParticipantHandTest==2 & AgentHandTest==2)))

RT_lowDensityUF3 <- matrix(, nrow = NP, ncol = NTest)  
length_lowDensityUF3=rowSums(RadiusTest==9 & catchTrialTest==0 & NumberOfAgentsTest==4 & ((ParticipantHandTest==1 & AgentHandTest==1)|(ParticipantHandTest==2 & AgentHandTest==2)))

RT_lowDensityUF5 <- matrix(, nrow = NP, ncol = NTest)  
length_lowDensityUF5=rowSums(RadiusTest==9 & catchTrialTest==0 & NumberOfAgentsTest==7 & ((ParticipantHandTest==1 & AgentHandTest==1)|(ParticipantHandTest==2 & AgentHandTest==2)))
# ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
length_highDensityUF3=rowSums(RadiusTest==3.3 & catchTrialTest==0 & NumberOfAgentsTest==4 & ((ParticipantHandTest==1 & AgentHandTest==1)|(ParticipantHandTest==2 & AgentHandTest==2)))

RT_highDensityUF5 <- matrix(, nrow = NP, ncol = NTest)  
length_highDensityUF5=rowSums(RadiusTest==3.3 & catchTrialTest==0 & NumberOfAgentsTest==7 & ((ParticipantHandTest==1 & AgentHandTest==1)|(ParticipantHandTest==2 & AgentHandTest==2)))
# ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
# for (a in 1:NP){
#   RT_Follow[a,length_RTF[a]]=responseTimeTest[a,(ParticipantHandTest==1 & AgentHandTest==2)|(ParticipantHandTest==2 & AgentHandTest==1)]
#   RT_Follow[a,length_RTUF[a]]=responseTimeTest[a,(ParticipantHandTest==1 & AgentHandTest==1)|(ParticipantHandTest==2 & AgentHandTest==2)]
...
for (a1 in 1:NP){
  ...
  #   RT_lowDensityUF1[a1,1:length_lowDensityUF1[a1]]=responseTimeTest[a1,(RadiusTest[a1,]==9 & catchTrialTest[a1,]==0 & NumberOfAgentsTest[a1,]==1 & ((ParticipantHandTest[a1,]==1 & AgentHandTest[a1,]==1)|(ParticipantHandTest[a1,]==2 & AgentHandTest[a1,]==2)))]
  # }
  if(length_lowDensityUF3[a1]!=0){
    RT_lowDensityUF3[a1,1:length_lowDensityUF3[a1]]=responseTimeTest[a1,(RadiusTest[a1,]==9 & catchTrialTest[a1,]==0 & NumberOfAgentsTest[a1,]==4 & ((ParticipantHandTest[a1,]==1 & AgentHandTest[a1,]==1)|(ParticipantHandTest[a1,]==2 & AgentHandTest[a1,]==2)))]
  }
  if(length_lowDensityUF5[a1]!=0){
    RT_lowDensityUF5[a1,1:length_lowDensityUF5[a1]]=responseTimeTest[a1,(RadiusTest[a1,]==9 & catchTrialTest[a1,]==0 & NumberOfAgentsTest[a1,]==7 & ((ParticipantHandTest[a1,]==1 & AgentHandTest[a1,]==1)|(ParticipantHandTest[a1,]==2 & AgentHandTest[a1,]==2)))]
  }
  ...
  if(length_highDensityUF3[a1]!=0){
    RT_highDensityUF3[a1,1:length_highDensityUF3[a1]]=responseTimeTest[a1,(RadiusTest[a1,]==3.3 & catchTrialTest[a1,]==0 & NumberOfAgentsTest[a1,]==4 & ((ParticipantHandTest[a1,]==1 & AgentHandTest[a1,]==1)|(ParticipantHandTest[a1,]==2 & AgentHandTest[a1,]==2)))]
  }
  if(length_highDensityUF5[a1]!=0){
    RT_highDensityUF5[a1,1:length_highDensityUF5[a1]]=responseTimeTest[a1,(RadiusTest[a1,]==3.3 & catchTrialTest[a1,]==0 & NumberOfAgentsTest[a1,]==7 & ((ParticipantHandTest[a1,]==1 & AgentHandTest[a1,]==1)|(ParticipantHandTest[a1,]==2 & AgentHandTest[a1,]==2)))]
  }
}
# Barplot for response time (low density or high density) ===============================================================================================================================
meanRTUF_lowDensity <- c(mean(RT_lowDensityUF3, na.rm=TRUE),mean(RT_lowDensityUF5, na.rm=TRUE))
meanRTUF_highDensity <- c(mean(RT_highDensityUF3, na.rm=TRUE),mean(RT_highDensityUF5, na.rm=TRUE))

stdRTUF_lowDensity <- c(sd(RT_lowDensityUF3, na.rm=TRUE),sd(RT_lowDensityUF5, na.rm=TRUE))
stdRTUF_highDensity <- c(sd(RT_highDensityUF3, na.rm=TRUE),sd(RT_highDensityUF5, na.rm=TRUE))
...
colnames(df5) <- c("NAgents","Density","meanValues","confidenceValues")
AsiColors<- c("darkseagreen3", "darkolivegreen4")
png(file="E:\\OngoingAnalysis\\SciOI_R\\SciOI_Density+GroupSize_R\\RTUFDensityOnlyAfterP.png", width=1200, height=700)
ggplot(df5, aes(x=NAgents, y=meanValues, fill=Density)) + geom_bar(stat='identity', position='dodge') + scale_fill_manual(values=AsiColors , labels=c('low Density', 'high Density')) + theme_bw(base_size = 18) + theme(panel.border = element_blank(), panel.grid.major = element_blank(), panel.grid.minor = element_blank() , axis.line = element_line(size = .5, linetype = "solid", colour = "black")) + scale_x_continuous(name="Number of agents" , breaks=seq(1,2), labels = c(4, 7)) + ggtitle("Response time") + ylab("Response time") + labs(fill = " ")+geom_errorbar(aes(ymin=meanValues-confidenceValues, ymax=meanValues+confidenceValues), width=.2, position=position_dodge(.9))
dev.off()
...
summary(fit1)
AsiColorsRegress<- c("darkolivegreen4","darkseagreen3")
png(file="E:\\OngoingAnalysis\\SciOI_R\\SciOI_Density+GroupSize_R\\RTUFRegressDensityOnlyAfterP.png", width=1200, height=700)
ggplot(df6,aes(y=RT,x=NAgents,color=factor(DensityFactor)))+geom_point()+stat_smooth(method="lm",se=TRUE) + scale_color_manual(values=AsiColorsRegress) + theme_bw(base_size = 18) + theme(text = element_text(size=20),panel.border = element_blank(), panel.grid.major = element_blank(), panel.grid.minor = element_blank() , axis.line = element_line(size = .5, linetype = "solid", colour = "black")) + scale_x_continuous(name="Number of agents" , breaks=seq(1,2), labels = c(4, 7)) + ggtitle("Response time") + ylab("Response time") + labs(fill = " ") 
dev.off()
...
density <- c(rep("LowDensity",NP*2),rep("HighDensity",NP*2))
NumAgents <- c(rep(c(rep(1,NP),rep(2,NP)),2))
RT <- c(rowMeans(RT_lowDensityUF3,na=TRUE),rowMeans(RT_lowDensityUF5,na=TRUE),rowMeans(RT_highDensityUF3,na=TRUE),rowMeans(RT_highDensityUF5,na=TRUE))
