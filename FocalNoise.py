...
for a in range(0,FocalLow4.shape[1]):
    MeanClose4.append(np.mean(FocalLow4[:,a,2]))
    STDClose4.append(np.std(FocalLow4[:,a,2]))
    MeanFar4.append(np.mean(FocalHigh4[:,a,2]))
    STDFar4.append(np.std(FocalHigh4[:,a,2]))
    MeanClose7.append(np.mean(FocalLow7[:,a,2]))
    STDClose7.append(np.std(FocalLow7[:,a,2]))
    MeanFar7.append(np.mean(FocalHigh7[:,a,2]))
    STDFar7.append(np.std(FocalHigh7[:,a,2]))
    
    Mean4.append(np.mean(FocalLow4[:,a,2]))
    Mean4.append(np.mean(FocalHigh4[:,a,2]))
    
    Mean7.append(np.mean(FocalLow7[:,a,2]))
    Mean7.append(np.mean(FocalHigh7[:,a,2]))
    
    MeanFocal.append(np.mean(FocalHigh4[:,a,2]))
    MeanFocal.append(np.mean(FocalHigh7[:,a,2]))
    
    MeanSparse.append(np.mean(FocalLow4[:,a,2]))
    MeanSparse.append(np.mean(FocalLow7[:,a,2]))
...
NoiseFocality=[]
NoiseFocality+=MeanFocal
NoiseFocality+=MeanSparse
