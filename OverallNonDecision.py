...
for a in range(0,OverallFar7.shape[1]):
    MeanClose4.append(np.mean(OverallClose4[:,a,3]))
    STDClose4.append(np.std(OverallClose4[:,a,3]))
    MeanFar4.append(np.mean(OverallFar4[:,a,3]))
    STDFar4.append(np.std(OverallFar4[:,a,3]))
    MeanClose7.append(np.mean(OverallClose7[:,a,3]))
    STDClose7.append(np.std(OverallClose7[:,a,3]))
    MeanFar7.append(np.mean(OverallFar7[:,a,3]))
    STDFar7.append(np.std(OverallFar7[:,a,3]))
    
    meanClose.append(np.mean(OverallClose4[:,a,3]))
    meanClose.append(np.mean(OverallClose7[:,a,3]))
    
    meanFar.append(np.mean(OverallFar4[:,a,3]))
    meanFar.append(np.mean(OverallFar7[:,a,3]))
    
    mean4.append(np.mean(OverallClose4[:,a,3]))
    mean4.append(np.mean(OverallFar4[:,a,3]))
    
    mean7.append(np.mean(OverallClose7[:,a,3]))
    mean7.append(np.mean(OverallFar7[:,a,3]))
Participant=[]
for a1 in range(0,2):
...
NonDecisionDensity=[]
NonDecisionDensity+=meanClose
NonDecisionDensity+=meanFar
...
df2 = pd.DataFrame({
    'Participant': Participant,
    'Condition': Condition,
    'NonDecision': NonDecisionDensity
})
# ANOVA =======================================================================
