...
MyOutliers=row(correctTestsPercentageOutliers)[which(!correctTestsPercentageOutliers == 0)]  
# indices of outliers
...
# 
# write.csv(responseTimeTest, "E:\\OngoingAnalysis\\SciOI_R\\SciOI_Density+GroupSize_R\\RT_Size.csv", row.names = FALSE)
# write.csv(ParticipantHandTest, "E:\\OngoingAnalysis\\SciOI_R\\SciOI_Density+GroupSize_R\\participantHand_Size.csv", row.names = FALSE)
# write.csv(nAgents1, "E:\\OngoingAnalysis\\SciOI_R\\SciOI_Density+GroupSize_R\\TotalNumberOfAgents_Size.csv", row.names = FALSE)
# write.csv(NumberOfAgentsTest, "E:\\OngoingAnalysis\\SciOI_R\\SciOI_Density+GroupSize_R\\NumberOfAgents_Size.csv", row.names = FALSE)